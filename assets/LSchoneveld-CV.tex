...
\begin{document}
	...
	\begin{resume}
		...
		\vspace{1mm}
		\begin{itemize}
			\item Research, develop and implement Powder's videogame highlights detection system, which is highly scalable thanks to a unique approach applying unsupervised learning to 1000s of hours of videogame footage.
			...
			\item Lead Powder's research collaboration with Dr.  Alice Othmani at Universit\'e Paris-Est Cr\'eteil (UPEC). Our latest two papers, currently under review, present state-of-the-art results for facial expression/emotion recognition.
		\end{itemize}
